...
/**
 * L2UnrealPackage stored in memory.
 *
 * @author acmi
 */
public class L2UnrealPackageM implements L2UnrealPackage {
    private int version;
    private int license;
    private int flags;
    ...
    public L2UnrealPackageM(UUID uuid) {
    ...
    public boolean equals(Object o) {
        ...
        L2UnrealPackageM that = (L2UnrealPackageM) o;
    ...
    public String toString() {
        return "L2UnrealPackage[" + uuid.toString() + "]";
    }

    public static L2UnrealPackageM read(RandomAccessInputStream input) throws IOException {
        ...
        try {
            ...
            L2UnrealPackageM unrealPackage = new L2UnrealPackageM(UUID.fromString(String.format(
    ...
    public static class L2UnrealPackageHeader {
        @IntConst(L2_UNREAL_PACKAGE_MAGIC)
        int signature = L2_UNREAL_PACKAGE_MAGIC;
        int version;
        int flags;
        int nameCount;
        int nameOffset;
    ...
    public static class Generation implements ee.l2.clientstuff.files.up.Generation {
    ...
    public final class NameEntry implements ee.l2.clientstuff.files.up.NameEntry {
    ...
    public final class ExportEntry extends IEEntry implements ee.l2.clientstuff.files.up.ExportEntry {
    ...
    public final class ImportEntry extends IEEntry implements ee.l2.clientstuff.files.up.ImportEntry {
